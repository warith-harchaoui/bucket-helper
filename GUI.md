...
error-prone at the CLI (typo the bucket name and data goes to the wrong
...
- **Provider identity is loud.** MinIO buckets are *green* and prefixed
  ...
  was your dev MinIO. Color, shape, and text; never color alone.
...
- Front end: TypeScript + Svelte 5. No React, to match the `front-ui`
